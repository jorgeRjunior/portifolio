...
export default function Profile() {
  return (
    <div className="flex h-[30vh] ml-[10vw] mt-[3vw] gap-9">
      <div id="perfil" className=''>
        <div className="flex flex-col h-[82vh] w-[20vw] rounded-[20px] border-[#41525b] border-4 bg-slate-100 min-w-[20rem]">
            ...
            <span className="flex justify-left text-[16px] text-[#8b9aab] font-light pt-1 pl-10 pb-5 pr-10 text-justify ">           
    ...
    <div className='flex flex-col '>
      <div id="experiencias" className="border-[#41525b] border-4 rounded-[20px] h-[38vh] w-[50vw] p-2 pl-8 ml-5 pr-10 pt-5 pb-10 bg-slate-100">
      ...
      <div id="skills" className="flex border-[#41525b] border-4 rounded-[20px] h-[38vh] w-[50vw] p-2 pl-8 ml-5 pr-10 pt-5 mt-10 pb-10 bg-slate-100">
